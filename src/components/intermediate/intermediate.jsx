...
const intermediate = profile => profile.fluency === "intermediate";
...
const profiles1 = profiles.filter(notMe).filter(online).filter(intermediate).filter(match);
        ...
        <Container fluid="md" key={profile.username}>
            ...
            <Row>
                <Col className="mt-1 mb-2">
                    Hi, My native language is {profile.native}. I have intermediate fluency in {profile.practice}.
                </Col>
            </Row>
            <Row>
                <Col>
